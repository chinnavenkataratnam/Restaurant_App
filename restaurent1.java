...
class menufood {
    ...
    void readinfile() {
        try {
            ...
            Scanner string2 = new Scanner(new FileReader("orderDetails.csv"));
            String s;
    ...
    void displayitems(ArrayList<ArrayList<String>> arr1) {
        int n = arr1.size();
        for (int i = 0; i < n; i++) {
    ...
    void cancelBill() {
        ...
        if (n > t) {
            ...
            try {
                FileWriter billobj = new FileWriter("orderDetails.csv", false);
                for (int i = 0; i < (arr2.size()); i++) {
                    ArrayList<String> str1 = arr2.get(i);
                    String Bill = String.join(",", str1);
                    Bill += "\n";
                    FileWriter billdetailsobj = new FileWriter("orderDetails.csv", true);
